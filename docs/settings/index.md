...
| **Layout / Home Shelf** | Toggle the **Show Continue Watching** shelf on the Home screen. Select a base home card type: **Card**, **Wide**, or **Poster**. Toggle **Resume prompt on launch** popups. | Switch home dashboards between Modern View, Grid View, or Classic View. Toggle Fullscreen Hero Backdrops and configure auto-collapsing sidebars. | Toggle the **Show Continue Watching** shelf, select a base home card type, enable the **card depth effect**, and toggle **Resume prompt on launch** popups. |
| **Up Next Behavior** | Configure **Prefer Episode Thumbnails**, **Up Next From Furthest Episode**, **Show Unaired Next Up Episodes**, and **Blur Unwatched**. | Configure series playback using *Prefer Binge Group*, *Reuse Binge Groups*, and *Next Episode Threshold Mode*. | Configure **Prefer Episode Thumbnails**, **Up Next From Furthest Episode**, **Show Unaired Next Up Episodes**, and **Blur Unwatched**. |
| **Poster Card Style** | Fine-tune card width and corner radius with a live preview. Toggle landscape posters and labels. | Fine-tune card width, corner radius, and backdrop expand delay. Toggle landscape posters. | Fine-tune card width, corner radius, and backdrop expand delay. Toggle landscape posters. |
...
- **Intro and Outro Skip:** Prioritizes segment database filters across IntroDB, AniSkip, and Anime Skip. Includes community timestamp submission tools [Mobile Windows], Content Warnings, and Automatic Skipping [Android TV Only].
