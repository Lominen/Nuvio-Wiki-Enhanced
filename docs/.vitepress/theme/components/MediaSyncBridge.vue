...
const syncCopy = computed(() => isDutch.value ? {
  ...
  diagFuzzyTitleMatches: 'Sterk gelijkende titels',
  diagSequenceCandidate: 'Volgorde-kandidaat',
  diagSequenceAnchors: 'Bevestigende afleveringen',
  ...
  diagFuzzyTitleMatches: 'Highly similar titles',
  diagSequenceCandidate: 'Sequence candidate',
  diagSequenceAnchors: 'Sequence anchors',
...
function diagnosticLabel(key: PreviewDiagnosticKey): string {
  const labels: Record<PreviewDiagnosticKey, string> = {
    ...
    fuzzyTitleMatches: copy.value.diagFuzzyTitleMatches,
    sequenceCandidate: copy.value.diagSequenceCandidate,
    sequenceAnchors: copy.value.diagSequenceAnchors,
